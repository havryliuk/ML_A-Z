...
salary_level_7_5_linear = linear_regression.predict([[7.5]])
salary_level_7_5_poly = polynomial_regression_2.predict(polynomial_features_2.fit_transform([[7.5]]))
print(salary_level_7_5_linear)
print(salary_level_7_5_poly)
